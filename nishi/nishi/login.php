    ...
    try {
          ...
          $user = $stmt->fetch(PDO::FETCH_OBJ);
            ...
            if($count) {
              ...
              $_SESSION['logged_in_name'] = $user->name;

              //if logged in user is admin or not.
              if($user->is_admin) {
                $_SESSION['admin_logged_in'] = $user->email;
              }

              //if superuser is logged in
              if($user->is_superUser) {
                $_SESSION['supper_user_logged_in'] = $user->email;
              }
...
<div class="container">
  ...
  <div class="row" id="login-page-container">
    <div class="col login-left-col">
      ...
      <ul>
        <li> Download paper on semester based.</li>
        <li> Download paper on Class based.</li>
      </ul>
    </div>
    <div class="col login-col">
      ...
      <form class="login-form" action="login.php" method="post">
            ...
            <button type="submit" name="loginUser" class="btn btn-success btn-block">Log in</button>
